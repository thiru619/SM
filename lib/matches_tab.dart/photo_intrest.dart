...
class photo_intrest extends StatefulWidget {
  const photo_intrest({Key? key}) : super(key: key);

  @override
  State<photo_intrest> createState() => _photo_intrestState();
}

class _photo_intrestState extends State<photo_intrest> {
  int _value = 0;
