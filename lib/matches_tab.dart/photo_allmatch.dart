...
class photo_allmatch extends StatefulWidget {
  const photo_allmatch({Key? key}) : super(key: key);

  @override
  State<photo_allmatch> createState() => _photo_allmatchState();
}

class _photo_allmatchState extends State<photo_allmatch> {
  int _value = 0;
