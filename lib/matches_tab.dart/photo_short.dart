...
class photo_short extends StatefulWidget {
  const photo_short({Key? key}) : super(key: key);

  @override
  State<photo_short> createState() => _photo_shortState();
}

class _photo_shortState extends State<photo_short> {
  int _value = 0;
