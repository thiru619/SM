...
class listview_intrest extends StatefulWidget {
  const listview_intrest({Key? key}) : super(key: key);

  @override
  State<listview_intrest> createState() => _listview_intrestState();
}

class _listview_intrestState extends State<listview_intrest> {
  var listprofile = [];
  @override
  void initState() {
    listview();
